...
namespace Domestica.Budget.Infrastructure.Migrations
{
    ...
    [Migration("20240209184459_transactionEntitiesRefactor")]
    partial class transactionEntitiesRefactor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domestica.Budget.Domain.Transactions.Transaction", b =>
                {
                    ...
                    b.Property<Guid?>("TransactionEntityId1")
                        .HasColumnType("uuid")
                        .HasColumnName("transaction_entity_id1");

                    b.Property<Guid?>("TransactionEntityId2")
                        .HasColumnType("uuid")
                        .HasColumnName("transaction_entity_id2");
                    ...
                    b.HasIndex("TransactionEntityId1")
                        .HasDatabaseName("ix_transactions_transaction_entity_id1");

                    b.HasIndex("TransactionEntityId2")
                        .HasDatabaseName("ix_transactions_transaction_entity_id2");
            ...
            modelBuilder.Entity("Domestica.Budget.Domain.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("Domestica.Budget.Domain.TransactionEntities.TransactionEntity", null)
                        .WithMany()
                        .HasForeignKey("TransactionEntityId1")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_transactions_transaction_entities_transaction_entity_id1");

                    b.HasOne("Domestica.Budget.Domain.TransactionEntities.TransactionEntity", null)
                        .WithMany()
                        .HasForeignKey("TransactionEntityId2")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_transactions_transaction_entities_transaction_entity_id2");
