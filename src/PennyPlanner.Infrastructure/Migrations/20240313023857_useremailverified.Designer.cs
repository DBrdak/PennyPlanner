...
namespace Domestica.Budget.Infrastructure.Migrations
{
    ...
    [Migration("20240313023857_useremailverified")]
    partial class useremailverified
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PennyPlanner.Domain.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.BudgetPlans.BudgetPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_budget_plans_user_id");

                    b.ToTable("budget_plans", (string)null);
                });

            modelBuilder.Entity("PennyPlanner.Domain.TransactionCategories.TransactionCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_transaction_categories_user_id");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.TransactionEntities.TransactionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_transaction_entities_user_id");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.TransactionSubcategories.TransactionSubcategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_transaction_subcategories_user_id");

                    b.ToTable("transaction_subcategories", (string)null);
                });

            modelBuilder.Entity("PennyPlanner.Domain.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.Accounts.SavingsAccounts.SavingsAccount", b =>
                {
                    b.HasBaseType("PennyPlanner.Domain.Accounts.Account");

                    b.HasDiscriminator().HasValue("SavingsAccount");
                });

            modelBuilder.Entity("PennyPlanner.Domain.Accounts.TransactionalAccounts.TransactionalAccount", b =>
                {
                    b.HasBaseType("PennyPlanner.Domain.Accounts.Account");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.TransactionCategories.IncomeTransactionCategory", b =>
                {
                    b.HasBaseType("PennyPlanner.Domain.TransactionCategories.TransactionCategory");

                    b.HasDiscriminator().HasValue("IncomeTransactionCategory");
                });

            modelBuilder.Entity("PennyPlanner.Domain.TransactionCategories.OutcomeTransactionCategory", b =>
                {
                    b.HasBaseType("PennyPlanner.Domain.TransactionCategories.TransactionCategory");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.TransactionEntities.TransactionRecipients.TransactionRecipient", b =>
                {
                    b.HasBaseType("PennyPlanner.Domain.TransactionEntities.TransactionEntity");

                    b.HasDiscriminator().HasValue("TransactionRecipient");
                });

            modelBuilder.Entity("PennyPlanner.Domain.TransactionEntities.TransactionSenders.TransactionSender", b =>
                {
                    b.HasBaseType("PennyPlanner.Domain.TransactionEntities.TransactionEntity");
            ...
            modelBuilder.Entity("PennyPlanner.Domain.Accounts.Account", b =>
                {
                    b.HasOne("PennyPlanner.Domain.Users.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PennyPlanner.Domain.BudgetPlans.BudgetPlan", b =>
                {
                    ...
                    b.OwnsMany("PennyPlanner.Domain.BudgetPlans.BudgetedTransactionCategory", "BudgetedTransactionCategories", b1 =>
                        {
                            b1.Property<Guid>("BudgetPlanId")
                                .HasColumnType("uuid")
                                .HasColumnName("budget_plan_id");
                            ...
                            b1.HasOne("PennyPlanner.Domain.TransactionCategories.TransactionCategory", "Category")
                                .WithMany()
            ...
            modelBuilder.Entity("PennyPlanner.Domain.TransactionSubcategories.TransactionSubcategory", b =>
                {
                    b.HasOne("PennyPlanner.Domain.TransactionCategories.TransactionCategory", "Category")
            ...
            modelBuilder.Entity("PennyPlanner.Domain.Transactions.Transaction", b =>
                {
                    b.HasOne("PennyPlanner.Domain.Accounts.Account", null)
                    ...
                    b.HasOne("PennyPlanner.Domain.BudgetPlans.BudgetPlan", null)
                        .WithMany("Transactions")
                        .HasForeignKey("BudgetPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                    ...
                    b.HasOne("PennyPlanner.Domain.TransactionEntities.TransactionEntity", null)
                        .WithMany()
                    ...
                    b.HasOne("PennyPlanner.Domain.TransactionSubcategories.TransactionSubcategory", "Subcategory")
                        .WithMany()
