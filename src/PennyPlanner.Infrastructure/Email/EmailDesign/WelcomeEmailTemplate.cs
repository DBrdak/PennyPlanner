namespace PennyPlanner.Infrastructure.Email.EmailDesign
{
    internal sealed class WelcomeEmailTemplate
    {
        ...
        internal WelcomeEmailTemplate(string username, string verificationUrl)
        {
            _username = username;
            _verificationUrl = verificationUrl;
        }

        internal string GetHtmlTemplate() =>
            $$$"""
               ...
               <![endif]-->
                 ...
                 </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="5d42b0b0-94de-4571-b098-ef8ad1e6e591">
                   <tbody>
                     <tr>
                       <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h1 style="text-align: center"><span style="font-family: helvetica,sans-serif">Welcome to Penny Planner {{{_username}}}!</span></h1>
               <h2 style="text-align: center"><span style="font-family: helvetica,sans-serif">Please verify your email</span></h2><div></div></div></td>
                     </tr>
                   </tbody>
                 </table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="11eac8b7-7e9a-4739-99cf-9620e9bf02ef">
                     <tbody>
                       <tr>
                         <td align="center" bgcolor="" class="outer-td" style="padding:20px 0px 20px 0px;">
                           <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                             <tbody>
                               <tr>
                               <td align="center" bgcolor="#FF69B4" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                 <a href="{{{_verificationUrl}}}" style="background-color:#FF69B4; border:1px solid #00FFFF; border-color:#00FFFF; border-radius:6px; border-width:1px; color:#ffffff; display:inline-block; font-size:24px; font-weight:700; letter-spacing:1px; line-height:normal; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:helvetica,sans-serif;" target="_blank">Verify</a>
                               </td>
                               </tr>
                             </tbody>
                           </table>
